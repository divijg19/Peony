...
var (
	...
	keyStyle          = lipgloss.NewStyle().Bold(true).Foreground(lipgloss.Color("223")).Background(lipgloss.Color("238")).Padding(0, 1)
	keyDescStyle      = lipgloss.NewStyle().Foreground(lipgloss.Color("250"))
	railPromptStyle   = lipgloss.NewStyle().Foreground(lipgloss.Color("252")).Background(lipgloss.Color("236")).Padding(0, 1)
	railKeyStyle      = lipgloss.NewStyle().Foreground(lipgloss.Color("250")).Background(lipgloss.Color("234")).Padding(0, 1)
